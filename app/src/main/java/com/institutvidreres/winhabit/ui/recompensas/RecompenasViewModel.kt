...
class RecompenasViewModel : ViewModel() {
    ...
    val personajesPremiumList = listOf(
        ...
        Recompensa("Personaje", 14, R.drawable.princesa, "Princesa", 500, userId)
    )

    val bannersPerfil = listOf(
        Recompensa("Banner", 20, R.drawable.gradiante_azul, "Azulado", 120, userId),
        Recompensa("Banner", 21, R.drawable.gradiante_purpura, "Gradiante Púrpura", 200, userId),
        Recompensa("Banner", 22, R.drawable.gradiante_rojo, "Gradiante Carmesí", 300, userId)
    )
    ...
    val bannersMulticolorPerfil = listOf(
        ...
        Recompensa("Banner", 26, R.drawable.gradiante_azul_purpura_rojo, "Fuego Violeta ¡TRICOLOR!", 500, userId),
